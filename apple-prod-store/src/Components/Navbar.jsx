...
const Navbar = ({ activePage, handleNavClick, isNavbarOpen, toggleNavbar }) => {
  return (
    <>
      <div className={`2xl:w-80 xl:w-52 w-44 h-full bg-[#f8f8f8] flex flex-col justify-between pt-5 pl-6 pb-14 mb:pb-0 absolute 
      md:relative z-10 transition-transform duration-800
     ${isNavbarOpen ? 'translate-x-0' : '-translate-x-100 md:translate-x-0'}`}>
        <a href="#" className="2xl:text-2xl xl:text-xl font-light text-red-600 mb-14 tracking-wider">Apple Products</a>
        ...
        <div className='flex justify-between pr-0.5 pb-1'>
          <a href="#">
    ...
    <button className='fixed md:hidden bottom-4 left-4 p-2 text-4xl text-blue-400 z-30' onClick={toggleNavbar}>
